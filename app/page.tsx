      ...
      <div className="flex-1 space-y-4 p-4 md:p-8 pt-6 ml-16 lg:ml-64">
        ...
        <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              <div className="text-xl lg:text-2xl font-bold">{metrics.totalRevenue.toLocaleString()} лв</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-xl lg:text-2xl font-bold text-green-600">
                {metrics.totalProfit.toLocaleString()} лв
              </div>
              <div className="flex items-center text-xs text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-xl lg:text-2xl font-bold">{metrics.totalOrders}</div>
              <div className="flex items-center text-xs text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-xl lg:text-2xl font-bold">{metrics.connectedStores}</div>
        ...
        {/* Recent Activity & Top Products - Stack on mobile */}
        <div className="grid gap-4 grid-cols-1 lg:grid-cols-2">
          {/* Recent Activity */}
          <Card>
            <CardHeader>
                ...
                {recentActivity.length > 0 ? (
                  recentActivity.map((activity) => (
                    <div key={activity.id} className="flex items-center space-x-4">
                      ...
                      {activity.amount && (
                        <div className="text-sm font-medium shrink-0">{activity.amount.toFixed(2)} лв</div>
                      )}
                    </div>
                  ))
                ) : (
            ...
            <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
              <Button asChild className="h-20 flex-col">
                <Link href="/shopify-orders">
                  ...
                  <span className="text-center">Sync Orders</span>
                </Link>
              </Button>
              <Button asChild variant="outline" className="h-20 flex-col bg-transparent">
                <Link href="/purchase-orders">
                  <Package className="h-6 w-6 mb-2" />
                  <span className="text-center">New PO</span>
                </Link>
              </Button>
              <Button asChild variant="outline" className="h-20 flex-col bg-transparent">
                <Link href="/inventory">
                  <Package className="h-6 w-6 mb-2" />
                  <span className="text-center">Check Stock</span>
                </Link>
              </Button>
              <Button asChild variant="outline" className="h-20 flex-col bg-transparent">
                <Link href="/reports">
